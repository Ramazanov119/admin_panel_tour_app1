...
class AddRecom extends StatefulWidget {
  const AddRecom({Key? key}) : super(key: key);

  @override
  _AddRecomState createState() => _AddRecomState();
}

class _AddRecomState extends State<AddRecom> {
  ...
  void _uploadForm() async {
    ...
    if (isValid) {
      ...
      try {
        ...
        await FirebaseFirestore.instance.collection('reck').doc(_uuid).set({
          'id': _uuid,
        ...
        Fluttertoast.showToast(
          msg: "Recommendation uploaded succefully",
